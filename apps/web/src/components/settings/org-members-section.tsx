...
/** Admin/member management for a specific organization (used by super admin console). */
  ...
  return (
    <div>
      <SectionHeading
        ...
        description="Assign an admin to run the organization's workspaces, or remove them."
      />
