...
export const SAMPLE_APPS: AppManifest[] = [
  ...
  },
  {
    ...
    version: "1.0.0",
    description: "Give an agent a purpose, skills, tools, a model and someone it answers to.",
    entities: ["agent", "skill", "connector"],
    capabilities: ["agent.configure", "agent.supervise"],
    tools: ["agent.update", "agent.grant"],
